...
<body>
    ...
    <Table Class="table table-striped table-hover table-bordered w.30">
        <thead>
            <tr>
                <th> Empleado</th>
                <th> Dia</th>
                ...
                success: function (msg) {
                    ...
                    for (i = 0; i < datos.length; i++) {
                        row += "<tr>" +
                            ...
                            "</td><td>" + datos[i].Fin +
                            "</td><td><a href='../../Reserva/Procesar/?empleado=" + datos[i].CodigoEmpleado + "&disp=" + datos[i].CodigoDisponibilidad + "&dia=" +dia+"'>Seleccionar</a> </td></tr>";
                    }
                    $("#planilla").html(row);
                },
                error: function () {
