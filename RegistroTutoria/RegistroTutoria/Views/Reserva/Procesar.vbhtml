...
<body>
    ...
    <div id="main">
        ...
        <h6 class="h6 text-center">Usted tiene @ViewData("reservasDisponibles") turnos disponibles de media hora en el siguiente horario: @ViewData("disponibilidadHorarios")</h6>
        ...
        <form title="Reserva" style="width:60%; height:65%; margin: auto; border: 1px solid darkred; border-radius: 2px;   padding-top: 50px;padding-right: 10px;padding-bottom: 10px;padding-left: 10px;"
            ...
            <div class="form-row">
                ...
                <input type="text" value="@ViewData("disponibilidad")" name="disponibilidad" hidden />
                <div class="col-md-4 mb-3">
